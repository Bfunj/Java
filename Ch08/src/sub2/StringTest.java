...
public class StringTest {
	public static void main(String[] args) {
		...
		}else System.out.println("str1과 str2는 문자열이 다르다");
		
		// 문자열 길이
		String str = "Hello korea";
		System.out.println("str3 길이 : " +str.length());
		...
		System.out.println("str 7부터 자르기 : "+str.substring(6));
		
		// 문자열 인덱스
		System.out.println("str 앞에서부터 문자 e 인덱스 : " + str.indexOf("e"));
		System.out.println("str 뒤에서부터 문자 e 인덱스 : " + str.lastIndexOf("e"));
		// 문자열 교체
		System.out.println("str 문자열에서 hello를 welcome 으로 교체"+str.replace("Hello","Welcome"));
		System.out.println("str 문자열에서 korea를 busan 으로 교체"+str.replace("korea","busan"));
